// src/ui/components/FileDropzone.tsx
import { useRef, type ChangeEvent } from "react";
import { UploadCloud } from "lucide-react";
import { splitSupportedPbixFiles, buildUnsupportedFilesMessage } from "../features/ingest/file-selection";
	...
	return (
		<div
			className={cn(
				...
				dragActive
					? "border-(--app-cta) bg-[color-mix(in_srgb,var(--app-cta)_14%,var(--color-ctp-surface0))]"
					: "border-(--app-border) bg-ctp-surface0",
			...
			<div className="flex flex-col items-center gap-4 text-center">
				<UploadCloud
					...
					className={cn(
						...
						dragActive ? "text-(--app-cta)" : "text-(--app-fg-muted)",
					)}
				/>
