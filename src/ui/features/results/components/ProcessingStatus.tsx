// src/ui/features/results/components/ProcessingStatus.tsx
import { AlertCircle, CheckCircle2, Loader2 } from "lucide-react";
import type { ResultsWorkflowStatus } from "../workflow/types";
...
export function ProcessingStatus({
	...
	if (failureCount > 0) {
		return (
			<div className="flex items-center gap-2 px-1 text-sm text-(--app-fg-warning)" role="status" aria-live="polite">
				<AlertCircle aria-hidden="true" className="h-4 w-4" />
				<span>
